"""
## STAGE TWO : LAND/FARM REGISTRATION
Testing:
...
testinvoke ed72a3d1e35420a8208f3f32e8e2815370ed1ed3 RegisterFarm ["Name","AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"]
testinvoke ed72a3d1e35420a8208f3f32e8e2815370ed1ed3 QueryFarm ["Name"]
...
def DeleteFarm(Farm_name):
    ...
    if not CheckWitness(owner):
        Notify("This person is not the owner of the farm, th farm cannot be deleted")
        return False
